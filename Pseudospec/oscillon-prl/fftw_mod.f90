...
!       : planf, planb : plans for required forward and backward transforms
    ...
    function gradient_energy_3d(n1,n2,n3,f,Fk,dk,planf) result(GE)
      real*8 :: GE
...
!$OMP PARALLEL DO PRIVATE(ii,jj,kk,rad2) FIRSTPRIVATE(n1,n2,n3,nn1,nn2,nn3,dk) REDUCTION(+:GE)
      ...
      enddo
!$OMP END PARALLEL DO
      GE = GE / dble(n1)**2 / dble(n2)**2 / dble(n3)**2  ! Get this normalization correct.  I think some of the issue is getting the fake modes initialized
    end function gradient_energy_3d
