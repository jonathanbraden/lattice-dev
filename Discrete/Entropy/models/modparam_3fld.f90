...
! These need to be adjusted for every model
  real, parameter, dimension(fields) :: fld0 = (/ phi0, 0.0, 0.0/)
  real, parameter, dimension(fields) :: dfld0 = (/ dphi0, 0.0, 0.0/)
  real, parameter, dimension(fields) :: ddfld0 = (/ ddphi0, 0.0, 0.0/)
